				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage User </h2>
								<ol class="breadcrumb">
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row row-sm">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="IMO Number" type="text"  required="">
											</div>
										...
										<div class="row row-sm mg-t-20">
											<div class="col-lg">
												<textarea class="form-control" placeholder="About" rows="5"></textarea>
											</div>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Edit User</button>
										...
										<table class="table" id="example2">
												...
												<tbody>
													<tr>
														...
														<td><a href="edituser.php"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
														<td>
