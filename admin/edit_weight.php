...
if(isset($_GET['id']))
$id=$_GET['id'];
$s=mysqli_query($db,"select * from weight where id='$id'");
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											...
											<div class="col-lg-6">
												<input class="form-control" placeholder="Weight" type="text" value="<?php echo $r[1]?>"  name="a" required="">
											</div>
...
if(isset($_POST['sub']))
{
$q=addslashes($_POST['a']);
// $a=addslashes($_POST['a1']);


$update=mysqli_query($db,"update weight set t1='$q' where id='$id' ");
msg(" successfully Updated","weight.php");
