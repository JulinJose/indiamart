...
<head>
    ...
    <div class="mg-t-20">
        ...
        <a href="?" class="btn ripple btn-secondary mb-1">Cancel</a>
    </div>
</form>
...
// Initialize variables to avoid undefined warning
$start = '';
$end   = '';
...
// Date filter for expenses (reuses the same GET param)
if (!empty($_GET['date_range'])) {
    $date_range = trim($_GET['date_range']);
