				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Track Details </h2>
								<ol class="breadcrumb">
...
if(isset($_GET['id']))
$id=$_GET['id'];
$s=mysqli_query($db,"select * from orders where id='$id'");
...
?> 
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Track Details</h6>
    ...
    <input  class="form-control" type="text" readonly value="EB<?php echo $r[0]; ?>" >
											</div>
											<div class="col-lg">
												<div class="col-lg">
										...
										<div class="mg-t-20">
											<button type="submit"  name="sub" class="btn ripple btn-primary mb-1">Add Tracking</button>
...
// $a=addslashes($_POST['a1']);


$update=mysqli_query($db,"update orders set status='$a' where id='$id' ");
msg(" successfully Updated","trackproduct.php");
