				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Privacy Policy </h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Privacy Policy</h6>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add Privacy</button>
