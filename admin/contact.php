						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Contact Us</h6>
												...
												<div class="row row-sm">
													<div class="col-sm-12 col-md-12 col-lg-12">
														<div class="input-group file-browser">
															<input type="text" class="form-control border-right-0 browse-file" placeholder="Upload Header Image" readonly required>
										...
										<div>
											<h6 class="main-content-label mg-t-20">Corporate Office Details</h6>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Phone Number 1" type="number" required>
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="Phone Number 2" type="number" required>
											</div>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Working Hours" type="text" required>
											</div>
										...
										<div>
											<h6 class="main-content-label mg-t-20">Abroad Office</h6>
										...
										<div class="row row-sm mg-t-20">
											<div class="col-lg">
												<input class="form-control" placeholder="Map Url" type="text" required>
											</div>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add Contact</button>
										...
										<table class="table" id="example2">
												<thead>
													<tr>
														...
														<th class="wd-15p">Contacted Status</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														...
														<td>+91 9048 606 388</td>
														<td>Test data for web</td>
														<td>Test message for web</td>
														<td>
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body" >
										<div>
											<h6 class="main-content-label mb-1">Shipment Enquiry</h6>
										</div>
										...
										<table class="table" id="example1" >
												<thead>
													<tr>
														...
														<th class="wd-15p">Phone</th>
														<th class="wd-15p">Subject</th>
														<th class="wd-15p">Delivery City</th>
														<th class="wd-15p">City of Departure</th>
														<th class="wd-15p">Weight</th>
														<th class="wd-15p">Height</th>
														<th class="wd-15p">Width</th>
