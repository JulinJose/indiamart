				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Homepage </h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Pages</a></li>
									<li class="breadcrumb-item active" aria-current="page">Manage Homepage</li>
								</ol>
							</div>
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Slider Section</h6>
											
										</div>

										<div class="row row-sm">
											<div class="col-lg">
												<input class="form-control" placeholder="Heading" type="text">
											</div>
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<div class="row row-sm">
													<div class="col-sm-12 col-md-12 col-lg-12">
														<div class="input-group file-browser">
															<input type="text" class="form-control border-right-0 browse-file" placeholder="Upload Slider Image" readonly>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add Slider</button>
							...
							<div class="col-lg-6 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">All Sliders</h6>
										</div>
													...
													<tr>
														<td>
															<div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/images/1.jpg">
															</div>
														</td>
														
														<td><a href="home.php"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Banner Down</h6>
											
										</div>

										<div class="row row-sm">
											<div class="col-lg">
												<input class="form-control" placeholder="Offer Percentage" type="text">
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="Heading 1" type="text">
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="Heading 2" type="text">
											</div>
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<div class="row row-sm">
													<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add section</button>
											<button type="button" class="btn ripple btn-secondary mb-1">Cancel</button>
										...
										<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-20p">Heading 1</th>
														<th class="wd-20p">Heading 2</th>
