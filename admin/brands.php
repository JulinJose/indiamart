				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Brands </h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Edit Brands</h6>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Edit Brands</button>
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Brand List</h6>
										</div>
										<table class="table" id="example2">
												...
												<tbody>
													<tr>
														<td>Godrej</td>
														<td>
															<div class="main-img-user  online text-center">
																<img alt="avatar"  src="assets/img/brand/4.png">
															</div>
														</td>
														
														
														<td><a href="brands.php"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
														<td>
