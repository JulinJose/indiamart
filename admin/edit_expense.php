...
if(isset($_GET['id']))
$id=$_GET['id'];
$s=mysqli_query($db,"select * from expense where id='$id'");
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Expense</h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Add Update </h6>
										...
										<div class="row">
											<div class="col-lg-4">
												<label>Date</label>
												<input class="form-control" placeholder="date" type="date"  value="<?php echo $r[3]?>" name="da" required="">
											</div>
											
											<div class="col-lg-4">
												<label>Category</label>
												<input class="form-control" placeholder="Category" type="text"   value="<?php echo $r[1]?>" name="a" required="">
											</div>
											
											<div class="col-lg-4">
												<label>Amount</label>
												<input class="form-control" placeholder="amount" type="number"   value="<?php echo $r[2]?>" name="b" required="">
											</div>
											</div>
										
										<div class="mg-t-20">
											<button type="Submit"  name="sub" class="btn ripple btn-primary mb-1">Update</button>
...
$update=mysqli_query($db,"update expense set category='$a', amount='$b',created_at='$da' where id='$id' ");
msg(" successfully Updated","expense.php");
