	...
	<body class="main-body leftmenu">
		...
		<div class="page main-signin-wrapper bgship2">
			...
			<div class="row signpages text-center">
				<div class="col-md-12">
					<div class="card mctrn">
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-4 pt-5 p-2 pos-absolute">
									<a href="index.php"><img src="assets/img/brand/logo-light.png" class="header-brand-img mb-4" alt="logo"></a>
...
<!-- Mirrored from laravel.spruko.com/spruha/ltr/reset by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Jun 2021 13:32:34 GMT -->
</html>