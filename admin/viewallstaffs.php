			...
			<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="index.php"><span class="shape1"></span><span class="shape2"></span><i class="ti-home sidemenu-icon"></i><span class="sidemenu-label">Dashboard</span></a>
						</li>
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-wallet sidemenu-icon"></i><span class="sidemenu-label">Clientside Pages</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="home.php">Home</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="about.php">About Us</a>
								</li>
								
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="contact.php">Contact Us</a>
								</li>
								<li class="nav-sub-item">
	<a class="nav-sub-link" href="faq.php">FAQ</a>
</li>


<li class="nav-sub-item">
	<a class="nav-sub-link" href="testimonials.php">Testimonials</a>
</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="terms.php">Terms & Conditions</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="privacy.php">Privacy Policy</a>
								</li>
							</ul>
						</li>
						
						<li class="nav-header"><span class="nav-label">Important</span></li>
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-map-alt sidemenu-icon"></i><span class="sidemenu-label">Products</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
...
<li class="nav-sub-item">
	<a class="nav-sub-link" href="wishlist.php">Wishlist</a>
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-agenda sidemenu-icon"></i><span class="sidemenu-label">Order Management</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="orderlist.php">Orders</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="trackproduct.php">Track Orders</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-shield sidemenu-icon"></i><span class="sidemenu-label">User Management</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="edituser.php">Edit User</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="usermanagement.php">View All</a>
								</li>
							</ul>
						</li>
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-package sidemenu-icon"></i><span class="sidemenu-label">Reports</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="reports.php">All Reports</a>
								</li>
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href="#"><span class="shape1"></span><span class="shape2"></span><i class="ti-lock sidemenu-icon"></i><span class="sidemenu-label">Authorization</span><i class="angle fe fe-chevron-right"></i></a>
							<ul class="nav-sub">
								
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="reset.php">Reset Password</a>
								</li>
								<li class="nav-sub-item">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="#.php">Sign Out</a>
								</li>
							</ul>
						</li>
					</ul>
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">View Staff </h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Staff List</h6>
										</div>
										<table class="table" id="example2">
												...
												<tbody>
													<tr>
														...
														<td>+91 5689 568 895</td>
														
														<td><a href="addstaff.php"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
