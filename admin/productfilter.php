...
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="mg-t-20">
        ...
        <a href="productfilter.php" class="btn ripple btn-secondary mb-1">Clear</a>
    </div>
</form>
...
<tr>
	...
	<td>
        <?php if (!empty($row['product_image'])) { ?>
            <img src="assets/images/products/<?php echo $row['product_image']; ?>" alt="<?php echo $row['product_names']; ?>" width="60" height="60">
        <?php } else { ?>
            <span>No Image</span>
        <?php } ?>
    </td>
    <td>
        <form method="POST" action="update_stock.php" class="d-flex">
            <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>">
            <input type="number" name="stock" value="<?php echo $row['stock']; ?>" class="form-control" style="width:80px; margin-right:5px;">
