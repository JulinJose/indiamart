									...
									<div class="card-body">
										...
										<div class="row row-sm">
											<div class="col-lg">
												...
												<input class="form-control" placeholder="Staff Name" name="name" type="text" required="">
											</div>
											<div class="col-lg">
											...
											<div class="col-lg">
												...
												<input class="form-control" placeholder="Email Id " name="email" type="text" required="">
											</div>
...
<!-- 
										...
										<div class="row row-sm">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Phone Number" type="number" name="ph"  required="">
											</div>
											<!-- <div class="col-lg">
											...
											<div class="col-lg mg-t-10 mg-lg-t-0">
												...
												<input class="form-control" placeholder="Designation" type="text" name="designation" required="">
											</div>
											...
											<div class="col-lg">
												<textarea class="form-control" placeholder="Address" name="address" rows="5"></textarea>
											</div>
...
$address      = addslashes($_POST['address']);
    ...
    $fileName1    = $_FILES['img']['name']; // fixed: use 'name', not 'img'
    ...
    if(isset($_FILES['img']['name']) && $_FILES['img']['name'] != "") {
        ...
        $allowedfileExtensions1 = array('jpg', 'gif', 'png', 'jpeg','webp'); // added 'webp' to allowed extensions
        ...
        if (in_array($fileExtension1, $allowedfileExtensions1)) {
            ...
            $ins = mysqli_query($db, "INSERT INTO `staff`(`id`, `img1`, `name`, `username`, `password`, `email`, `ph`, `destination`, `role`, `address`) 
                VALUES ('','$newFileName1', '$name', '$username', '$password', '$email', '$contactno', '$designation', '$role', '$address')");

            if($ins) {
                move_uploaded_file($fileTmpPath1, $dest_path1);
                msg("Successfully added","addstaff.php");
            } else {
                msg("Database error, please try again","addstaff.php");
            }
        } else {
            msg("Image extension should be jpg, jpeg, gif, or png", "addstaff.php");
        }
    }
}
?>
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">User Management</h6>
										</div>
										<table class="table" id="example2">
												<thead>
													...
													<tr>
														...
														<!-- <th class="wd-20p">Suspend/Active</th> -->
												...
												<tbody>
													<?php
                                    $s1=mysqli_query($db,"select * from staff ");
													...
													<tr>
														...
														<td>
															<div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/images/staff/<?php echo $r1[1]?>">
															</div>
														</td>
														...
														<td><a href="edit_staff.php?id=<?php echo $r1[0]?>"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
														<!-- <td>
