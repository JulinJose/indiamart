...
{
 $sql_query="DELETE FROM expense WHERE id=".$_REQUEST['deletepro_id'];
...
function deletepro_id(id)
{
     ...
     {
        window.location.href='expense.php?deletepro_id='+id;
     }
}
</script>
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-lg-4">
												<label>Date</label>
												<input class="form-control" placeholder="date" type="date"  name="da" required="">
											</div>
											
											<div class="col-lg-4">
												<label>Category</label>
												<input class="form-control" placeholder="Category" type="text"  name="a" required="">
											</div>
											
											<div class="col-lg-4">
												<label>Amount</label>
												<input class="form-control" placeholder="amount" type="number"  name="b" required="">
											</div>
											</div>
										
										<div class="mg-t-20">
											<button type="Submit"  name="sub" class="btn ripple btn-primary mb-1">Add</button>
...
if (isset($_POST['sub'])) {
	...
	$da=addslashes($_POST['da']);

        $ins = mysqli_query($db, "INSERT INTO expense VALUES (0, '$a','$b', '$da')");
        if ($ins) {
            msg("Successfully added", "expense.php");
        } else {
            msg("Database error: " . mysqli_error($db), "expense.php");
        }
        exit;
    }
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Expense Details</h6>
										</div>
										<table class="table" id="example2">
												...
												<tbody>
                                                    <?php
                                    $s1=mysqli_query($db,"select * from expense ");
                                    ...
                                    ?>
													<tr>
														...
														<td><?php echo $r1[1]?></td>
														<td><?php echo $r1[2]?></td>
														<td><a href="edit_expense.php?id=<?php echo $r1[0]?>"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a></td>
