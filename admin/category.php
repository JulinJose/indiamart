...
{
 $sql_query="DELETE FROM category WHERE id=".$_REQUEST['deletepro_id'];
...
function deletepro_id(id)
{
     ...
     {
        window.location.href='category.php?deletepro_id='+id;
     }
}
</script>
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row row-sm">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Category Name" name="a" type="text" required="">
											</div>
										...
										<div class="mg-t-20">
											<button type="submit"  name="sub1" class="btn ripple btn-primary mb-1">Add Category</button>
...
$fileTmpPath = $_FILES['a1']['tmp_name'];
        ...
        move_uploaded_file($fileTmpPath, $dest_path);
            ...
            $ins=mysqli_query($db,"insert into category values('0','$a','$newFileName','$da')");

            msg(" successfully added","category.php");

       }
	   else
	   {
		msg("Invalid File Type", "category.php");
	   }
    }
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<table class="table" id="example2">
												<thead>
													<tr>
														<!-- <th class="wd-20p">Barnd Image</th> -->
												...
												<tbody>
													<?php
                                    $s1=mysqli_query($db,"select * from category ");
													...
													<tr>
														...
														<!-- <td>
															<div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/img/brand/4.png">
															</div>
														</td> -->
														<!-- <td>Kitchen Appliances</td> -->
														<td>
															<div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/images/category/<?php echo $r1[2];?>">
															</div>
														</td>
														
														<td><a href="category_edit.php?id=<?php echo $r1[0]?>"><i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title="" data-placement="top" data-original-title="Edit"></i></a>
													<a href="javascript:deletepro_id(<?php echo $r1[0]; ?>)" title="Delete" data-toggle="tooltip" data-original-title="Delete" title="Delete"><i class="ti-trash" class="mst"style="font-size: 15px !important;"></i> </a>    </td>
														<!-- <td id='swal-warning'></td> -->
													</tr>
													<?php
									}
									?>
