...
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="row row-sm">
        <div class="col-lg">
            ...
            <select class="form-control select2" name="category_id">
                ...
                while ($r3 = mysqli_fetch_row($s3)) {
                    $selected = ($_GET['category_id'] ?? '') == $r3[0] ? 'selected' : '';
        ...
        <div class="col-lg">
            ...
            <select class="form-control select2" name="product_id">
                ...
                <?php
                $s3 = mysqli_query($db, "select * from products");
                while ($r3 = mysqli_fetch_row($s3)) {
                    $selected = ($_GET['product_id'] ?? '') == $r3[0] ? 'selected' : '';
                    echo "<option value='{$r3[0]}' $selected>{$r3[4]}</option>";
                }
                ?>
            </select>
        </div>
        ...
        <div class="col-lg">
            ...
            <select class="form-control select2" name="user_id">
                ...
                while ($r3 = mysqli_fetch_row($s3)) {
                    $selected = ($_GET['user_id'] ?? '') == $r3[0] ? 'selected' : '';
                    echo "<option value='{$r3[0]}' $selected>{$r3[1]}</option>";
                }
                ?>
            </select>
    ...
    <select class="form-control select2" name="status">
        ...
        <option value="out_for_delivery" <?php if(($_GET['status'] ?? '')=='out_for_delivery') echo 'selected'; ?>>Out for Delivery</option>
    ...
    <div class="mg-t-20">
        ...
        <a href="reports.php" class="btn ripple btn-secondary mb-1">Clear</a>
    </div>
</form>
											
										</div>
										<!-- <div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Search Now</button>
...
if (!empty($_GET['date_range'])) {
    ...
    // If input contains " - ", treat as range
...
<tr>
    ...
    <td>
        <a href="invoice.php?order_id=<?php echo $row['order_id']; ?>" 
           target="_blank" class="btn btn-sm btn-primary">Print Invoice</a>
    </td>
</tr>
<?php } ?>
