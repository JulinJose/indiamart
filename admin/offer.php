				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Offer </h2>
								<ol class="breadcrumb">
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Add Offer</h6>
										...
										<div class="row row-sm">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Price" type="text"  required="">
											</div>
											
											
											
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<input class="form-control" placeholder="Offer %" type="text" required="">
											</div>											
										</div>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add Offer</button>
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Offer Details</h6>
										</div>
