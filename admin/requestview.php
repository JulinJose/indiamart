				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Order </h2>
								<ol class="breadcrumb">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row row-sm">
											<div class="col-lg">
												<input class="form-control" placeholder="Oreder ID" type="text" readonly>
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="User Name" type="text" readonly>
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="emailid" type="text" readonly>
											</div>

											<div class="col-lg">
												<input class="form-control" placeholder="phonenumber" type="text" readonly>
											</div>
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<input class="form-control" placeholder="Country" type="text"  readonly>
											</div>
										</div>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<textarea class="form-control" placeholder="Address to Ship" rows="5"></textarea>
											</div>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="VAT" type="text" readonly>
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="Payment Method" type="text" readonly>
											</div>

											<div class="col-lg">
												<input class="form-control" placeholder="Oder Date" type="text" readonly>
											</div>
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<div class="col-lg">
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" checked>
													<label class="form-check-label" for="inlineCheckbox1" >Fresh Order</label>
													</div>
													<div class="form-check form-check-inline">
													<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
													<label class="form-check-label" for="inlineCheckbox2">Re Order</label>
													</div>

													<div class="form-check form-check-inline">
													<input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
													<label class="form-check-label" for="inlineCheckbox3">Replacement</label>
													</div>
										...
										<div>
											<h6 class="main-content-label mg-t-20">Ordered Products</h6>
										...
										<table class="table" id="example2">
												...
												<tbody>
													<tr>
														<td>Godrej</td>
														<td>Kitchen Appliences</td>
														<td>Micro Oven</td>
														<td><div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/img/Product/1.png">
															</div></td>
														<td>4</td>
														<td>2000</td>
														<td>400</td>
														<td><span class="badge badge-danger-light badge-pill">On Progress</span></td>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Edit Order</button>
