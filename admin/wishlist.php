				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Wishlist </h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Pages</a></li>
									<li class="breadcrumb-item active" aria-current="page">Manage Wishlist</li>
								</ol>
							</div>
						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Wishlist Details</h6>
										...
										<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-20p">Number of Products</th>
												...
												<tbody>
													<tr>
														...
														<td>20-12-24</td>
														<td>4</td>
														<td><button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modal-fullscreen-md-down">   View</button></td>
