								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<!-- <div class="row row-sm mg-t-20">
												...
												<div class="row row-sm">
													<div class="col-sm-12 col-md-12 col-lg-12">
														<div class="input-group file-browser">
															<input type="text" class="form-control border-right-0 browse-file" placeholder="Upload Image" readonly  required="">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="SKU" type="text"  required="">
											</div>
										...
										<div class="row row-sm mg-t-20">
											<div class="col-lg">
												<input class="form-control" placeholder="Old Price" type="text"  required="">
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="New Price" type="text"  required="">
											</div>
											
											
											
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<input class="form-control" placeholder="Stock" type="text" required="">
											</div>											
										</div>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<textarea class="form-control" placeholder="Care Instruction" rows="5"></textarea>
											</div>
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<textarea class="form-control" placeholder="Return Policy" rows="5"></textarea>
										...
										<div class="row row-sm mg-t-20">
											...
											<div class="col-lg">
												<input class="form-control" placeholder="Package Information" type="text"  required="">
											</div>
											<div class="col-lg">
												<input class="form-control" placeholder="Manufacturer" type="text"  required="">
											</div>
											
											
											<div class="col-lg mg-t-10 mg-lg-t-0">
												<input class="form-control" placeholder="Item Part Number" type="text" required="">
											</div>											
										</div>
										...
										<div class="mg-t-20">
											<button type="button" class="btn ripple btn-primary mb-1">Add Product</button>
													...
													<tr>
														...
														<td>
															<div class="main-img-user avatar-lg online text-center">
																<img alt="avatar" class="rounded-circle" src="assets/img/cat/vegitable.png">
															</div>
														</td>
														<td>2500.00</td>
