...
//        $html.="</tr>";
        ...
        $mysqli->query($query);
        $pize_Per=$amt/$page;
$query1 = "INSERT INTO `works`(`quotation_no`, `invoice_no`, `form_no`, `client_no`, `type_form`, `type_to`, `no_of_page`, `prize_per_page`, `w_total_cost`, `delivery_dt`, `translation_type`, `discription`,`w_vat`, `w_st`,`translation_service`) "
        . "VALUES('0','$ino','$nextId_t','$cl_no',"
        . "'---','---','$page','$pize_Per','$amt',"
        . "'$re_dt','$tr_type','$des','0','0','null')";
...
$query4 ="INSERT INTO `receipts`(`receipt_no`, `client_no`, `quotation_no`, `invoice_no`, `form_no`, `date`, `purpose`,
    `no_of_page`, `total_amount`,`st`,`transation_type`)
        ...
        . "'$nextId_t','$re_dt','--','$page','$amt','0','Cash')";
//echo"$query4";
